...
urlpatterns = [
    ...
    path("clientes/listar", views.listar_clientes, name="lista_client"),
    path("bibliotecas/listar", views.listar_biblioteca, name="lista_biblio"),
    ...
    path("libro/formulario", views.libro_create, name = "formulario")
